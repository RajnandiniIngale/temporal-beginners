...
export declare class Worker {
    ...
    protected createWorkflow(activation: coresdk.workflow_activation.WorkflowActivation, startWorkflow: coresdk.workflow_activation.IStartWorkflow): Promise<WorkflowWithLogAttributes>;
    /**
